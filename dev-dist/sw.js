...
registerRoute(/\/api\/v1\/stocks\/[^\/]+$/, new StaleWhileRevalidate({
...
registerRoute(/\/api\/v1\/stocks\/search/, new NetworkFirst({
...
registerRoute(/\/api\/v1\/stocks\/[^\/]+\/history/, new CacheFirst({
...
registerRoute(/\/api\/v1\/watchlist/, new NetworkFirst({
  "cacheName": "watchlist-data",
  "networkTimeoutSeconds": 3,
  plugins: [new ExpirationPlugin({
    maxEntries: 10,
    maxAgeSeconds: 3600
  }), new BackgroundSyncPlugin("watchlistSync", {
    maxRetentionTime: 1440
  })]
}), 'GET');
registerRoute(/\/api\/v1\/portfolio/, new NetworkFirst({
  "cacheName": "portfolio-data",
  "networkTimeoutSeconds": 3,
  plugins: [new ExpirationPlugin({
    maxEntries: 10,
    maxAgeSeconds: 3600
  }), new BackgroundSyncPlugin("portfolioSync", {
    maxRetentionTime: 1440
  })]
}), 'GET');
