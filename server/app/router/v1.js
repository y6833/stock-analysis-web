...
module.exports = (app) => {
  ...
  // ==================== 认证相关 ====================
  router.post('/api/v1/auth/register', controller.user.register);
  router.post('/api/v1/auth/login', controller.user.login);
  router.post('/api/v1/auth/logout', auth, controller.user.logout);
  router.post('/api/v1/auth/refresh', auth, controller.user.refreshToken);
  router.post('/api/v1/auth/password-reset', controller.user.requestPasswordReset);
  router.get('/api/v1/auth/validate', auth, controller.user.validateToken);
  ...
  // ==================== 技术分析 ====================
  router.get('/api/v1/analysis/indicators/:symbol', controller.technicalIndicators.calculateIndicators);
  ...
  router.get('/api/v1/simulation/accounts/:id/transactions', auth, controller.simulation.getTransactions);
  ...
  // ==================== 系统管理 ====================
  router.get('/api/v1/system/health', controller.health.system);
  router.get('/api/v1/system/cache/stats', auth, controller.cache.getStatus);
  router.post('/api/v1/system/cache/refresh', auth, controller.cache.refreshCache);
  router.delete('/api/v1/system/cache/:key', auth, controller.cache.clearCache);
